                    ...
                    fetch("<?php echo e(route('cart.confirm')); ?>", {
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                <?php $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    message += `--------------------------------\n`;
                                    message += `*Judul Buku*  : <?php echo e($item->product->judul); ?>\n`;
                                    message +=
                                        `Harga Satuan  : Rp <?php echo e(number_format($item->product->harga, 0, ',', '.')); ?>\n`;
                                    message += `Jumlah        : <?php echo e($item->quantity); ?> buku\n`;
                                    message +=
                                        `Subtotal      : Rp <?php echo e(number_format($item->subtotal, 0, ',', '.')); ?>\n`;
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                message +=
                                    `\n*TOTAL PEMBAYARAN*: Rp <?php echo e(number_format($cart->total, 0, ',', '.')); ?>\n\n`;
                                message += `*Nomor Pesanan*: ${data.order_number}\n\n`;
                                message +=
                                    `Mohon konfirmasi ketersediaan stok dan estimasi pengiriman. Terima kasih.`;

                                const whatsappUrl =
                                    `https://wa.me/628xxx?text=${encodeURIComponent(message)}`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Pandu-Projek\web-buku\resources\views/keranjang.blade.php ENDPATH**/ ?>